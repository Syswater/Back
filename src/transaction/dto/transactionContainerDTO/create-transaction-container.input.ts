...
export class CreateTransactionContainer {
  ...
  @IsNotEmpty({ message: 'El id de la distribución no puede estar vacio' })
  @IsInt({ message: 'El id de la distribución debe ser un numero entero' })
  @IsPositive({ message: 'El id de la distribución debe ser positivo' })
